...
<div class="section-body">
  <h2 class="section-title">Edit a Book</h2>
  <p class="section-lead">This page is just an example for you to create your own page.</p>

  <div class="container">
    <div class="card shadow">
      <form class="needs-validation" novalidate="" action="<?= route_to('book-update', $book->id) ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <select class="form-control selectric" name="genre" required>
                  <?php foreach ($genres as $genre) : ?>
                    <option value="<?= $genre->id ?>" <?= $book->genre_id === $genre->id ? 'selected' : '' ?>><?= $genre->display_name ?></option>
                  <?php endforeach; ?>
                </select>
                <div class="invalid-feedback">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" name="price" class="form-control currency" value="<?= $book->price ?>" required>
                </div>
                <div class="invalid-feedback">
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control" name="total_pages" value="<?= $book->total_pages ?>" required>
                <div class="invalid-feedback">
              ...
              <div class="form-group">
                <label>Stock</label>
                <input type="number" class="form-control" name="quantity" value="<?= $book->quantity ?>" required placeholder="10">
                <div class="invalid-feedback">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control datepicker" name="release_date" value="<?= $book->release_date ?>" required>
                </div>
                <div class="invalid-feedback">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <textarea class="summernote-simple" name="description"><?= $book->description ?></textarea>
                <div class="invalid-feedback">
